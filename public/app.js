...
document.addEventListener('DOMContentLoaded', () => {
  ...
  tl.to('.gsap-header', { opacity: 1, duration: 0.8, ease: "power2.out" })
    .fromTo('.logo-icon-wrap', { scale: 0.4, opacity: 0, rotate: -15 }, { scale: 1, opacity: 1, rotate: 0, duration: 0.5, ease: "back.out(2)" }, "-=0.6")
    .fromTo('.logo-pay-pill', { scale: 0, opacity: 0 }, { scale: 1, opacity: 1, duration: 0.55, ease: "back.out(2.5)" }, "-=0.35")
